...
namespace ChattingApp.Migrations
{
    ...
    [Migration("20221022185851_identity-role")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChattingApp.Domain.Models.AppUsers", b =>
                {
            ...
            modelBuilder.Entity("ChattingApp.Domain.Models.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ChattingApp.Domain.Models.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChattingApp.Domain.Models.AppRole", b =>
                {
            ...
            modelBuilder.Entity("ChattingApp.Domain.Models.AppUsers", b =>
                {
                    b.OwnsMany("ChattingApp.Helper.Security.Tokens.RefreshToken", "RefreshTokens", b1 =>
                        {
            ...
            modelBuilder.Entity("ChattingApp.Domain.Models.Message", b =>
                {
                    b.HasOne("ChattingApp.Domain.Models.AppUsers", "Receiver")
                        .WithMany("MessageRecieved")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ChattingApp.Domain.Models.AppUsers", "Sender")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ChattingApp.Domain.Models.AppUsers", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ChattingApp.Domain.Models.AppRole", b =>
                {
                    b.HasOne("ChattingApp.Domain.Models.AppRole", null)
                        .WithMany("UserRoles")
